...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/jmod/explosives/grenades/bundlenade/bundle_grenade.mdl", bone = "ValveBiped.Grenade_body", rel = "", pos = Vector(-0.259, 0.14, 0.9), angle = Angle(20, 35, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/jmod/explosives/grenades/bundlenade/bundle_grenade.mdl", bone = "ValveBiped.Anim_Attachment_RH", rel = "", pos = Vector(0.4, -0.0, 0.8), angle = Angle(110, 65, -159), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.PrintName    = "EZ Gebalte Ladung"                        
SWEP.Author       = "Kiralex"
SWEP.Instructions = "poshel v popu"
SWEP.Purpose	  = "Just a Stick Nade Bundle"

...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/jmod/explosives/grenades/firenade/incendiary_grenade.mdl", bone = "ValveBiped.Grenade_body", rel = "", pos = Vector(-0.159, 0.34, -1.5), angle = Angle(0, 45, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/mats_jack_nades/tear_gas_grenade", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/jmod/explosives/grenades/firenade/incendiary_grenade.mdl", bone = "ValveBiped.Anim_Attachment_RH", rel = "", pos = Vector(0.3, -0.0, 0), angle = Angle(110, 65, -159), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/mats_jack_nades/tear_gas_grenade", skin = 0, bodygroup = {} }
}
...
function SWEP:Throw()
	...
	function Throw()
		if SERVER then
			...
			phys:SetVelocity(self.Owner:GetVelocity() + self.Owner:GetAimVector() * 950)

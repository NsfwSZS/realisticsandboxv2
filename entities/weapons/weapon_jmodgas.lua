...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/jmod/explosives/grenades/gasnade/gas_grenade.mdl", bone = "ValveBiped.Grenade_body", rel = "", pos = Vector(-0.159, 0.34, -3.0), angle = Angle(0, 45, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/jmod/explosives/grenades/gasnade/gas_grenade.mdl", bone = "ValveBiped.Anim_Attachment_RH", rel = "", pos = Vector(0.4, -1, 0.3), angle = Angle(110, 80, -159), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.PrintName    = "EZ Gas Grenade"                        
SWEP.Author       = "Kiralex"
SWEP.Instructions = "Left-Click: Throw\nRight-Click: Toss"
SWEP.Purpose	  = "Gas Gas Gas"
...
function SWEP:Throw()
	...
	function Throw()
		if SERVER then
			grenade = ents.Create("ent_jack_gmod_ezgasnade")

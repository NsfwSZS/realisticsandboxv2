...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/jmod/explosives/grenades/flashbang/flashbang.mdl", bone = "ValveBiped.Grenade_body", rel = "", pos = Vector(-0.159, 0.34, -1.5), angle = Angle(0, 45, 180), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/jmod/explosives/grenades/flashbang/flashbang.mdl", bone = "ValveBiped.Anim_Attachment_RH", rel = "", pos = Vector(0.3, -0.0, 0), angle = Angle(110, 65, -159), size = Vector(1.17, 1.17, 1.17), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.PrintName    = "EZ Flashbang"                        
SWEP.Author       = "Kiralex"
SWEP.Instructions = "Left-Click: Throw\nRight-Click: Toss"
SWEP.Purpose	  = "Just a Flashbang"
...
function SWEP:Throw()
	...
	function Throw()
		if SERVER then
			grenade = ents.Create("ent_jack_gmod_ezflashbang")
